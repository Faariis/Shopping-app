...
CREATE TABLE `shopping_items` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `item_name` (`name`),
  CONSTRAINT `shopping_items_chk_1` CHECK ((`stock_count` >= 0))
...
INSERT INTO `shopping_items` VALUES (1,'Mobitel 1',3),(2,'Mobitel 2',3),(3,'Mobitel 3',3),(4,'Mobitel 4',3),(5,'Mobitel 5',3);
